(ns github.sergeiudris.rovers.player.main
  (:require
   ...
   [github.sergeiudris.rovers.player.impl :as player.impl]

   [github.sergeiudris.rovers.player.main.spec :as player.main.spec]
   [github.sergeiudris.rovers.player.main.chan :as player.main.chan]))
