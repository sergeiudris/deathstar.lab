(ns github.sergeiudris.rovers.player.chan
  #?(:cljs (:require-macros [github.sergeiudris.rovers.player.chan]))
  (:require
   ...
   [github.sergeiudris.rovers.player.spec :as scenario.player.spec]))
